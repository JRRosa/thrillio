package com.project.thrillio.contants;
...
public class MovieGenre {
    ...
    public static final String SCIFI_AND_FANTASY = "Sci-Fi And Fantasy";
    public static final String COMEDY = "Comedy";
    public static final String CHILDREN_AND_FAMILY = "Children & Fantasy";
    public static final String ACTION_AND_AVENTURE = "Action & Adventure";
